...
class ChatScreenState extends State<ChatScreen> {
  ...
  readLocal() async {
    Firestore.instance.collection('users').document(groupChatId).updateData({'chattingWith': service.clientUserID});
    setState(() {});
  }
    ...
    if (content.trim() != '') {
      ...
      Firestore.instance.runTransaction((transaction) async {
        await transaction.set(
          documentReference,
          {
            'idFrom': service.OperadorPartnerId,
  ...
  Widget buildInput() {
    return Container(
      ...
      decoration: new BoxDecoration(
          border: new Border(top: new BorderSide(color: Colors.black, width: 0.5)), color: Colors.white),
    );
  }
